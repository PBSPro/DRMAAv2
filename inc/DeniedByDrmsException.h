 ...
 * @brief Exception is generated when request is denied by DRMS
 */
class DeniedByDrmsException: public Drmaa2Exception {
public:
	 ...
	 */
	DeniedByDrmsException(const SourceInfo &sourceInfo = SourceInfo(),
			const Message &message = Message(DENIED_BY_DRMS_SHORT,
			DENIED_BY_DRMS_LONG));
	 ...
	 *
	 */
	virtual ~DeniedByDrmsException() throw();
};
