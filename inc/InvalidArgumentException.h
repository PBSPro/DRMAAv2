 ...
 * @brief Exception is generated for invalid Argument
 */
class InvalidArgumentException: public Drmaa2Exception {
public:
	 ...
	 */
	InvalidArgumentException(const SourceInfo &sourceInfo = SourceInfo(),
				const Message &message = Message(INVALID_ARG_SHORT,
						INVALID_ARG_LONG));
