 ...
 * @brief Exception is generated for invalid session
 */
class InvalidSessionException: public Drmaa2Exception {
public:
	 ...
	 */
	InvalidSessionException(const SourceInfo &sourceInfo = SourceInfo(),
				const Message &message = Message(INVALID_SESSION_SHORT,
						INVALID_SESSION_LONG));
